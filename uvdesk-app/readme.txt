...
8. This screen shot description corresponds to 8.png. and it shows that you need to go to domain you have selected like opencart.uvdesk.com and after login as shown you need to create and access token which you will later use in uvdesk settings.
