...
if ( ! class_exists( 'WK_UVDESK_Install' ) ) {
	/**
	 * WK_UVDESK_Install Class.
	 */
	class WK_UVDESK_Install {
		/**
		 * Instance variable
		 *
		 * @var $instance
		...
		public function __construct() {
			add_action( 'init', array( $this, 'wk_uvdesk_install' ) );
		}
		 ...
		 * @return void
		 */
		public function wk_uvdesk_create_pages() {
