...
if ( ! class_exists( 'WK_UVDESK_Register' ) ) {
	/**
	 * WK_UVDESK_Register class.
	 */
	class WK_UVDESK_Register {
		/**
		 * Instance variable
		 *
		 * @var $instance
		...
		public function __construct() {
			add_shortcode( 'uvdesk', array( $this, 'wk_uvdesk_display_uvdesk_form' ) );
		}
		 ...
		 * @return void
		 */
		public function wk_uvdesk_display_uvdesk_form() {
			...
			<div class="wk-uvdesk-signup-form">
				...
				<form method="POST" action="">
					...
					<?php $this->wk_uvdesk_process_registration(); ?><br><br>
		 ...
		 * @return void
		 */
		public function wk_uvdesk_process_registration() {
