...
if ( ! class_exists( 'WK_UVDESK_Download' ) ) {
	/**
	 * WK_UVDESK_Download class.
	 */
	class WK_UVDESK_Download {
		/**
		 * Instance variable
		 *
		 * @var $instance
		...
		public function __construct() {
			$this->wk_uvdesk_customer_download_ticket_file();
		}
		 ...
		 * @return string
		 */
		public function wk_uvdesk_customer_download_ticket_file() {
