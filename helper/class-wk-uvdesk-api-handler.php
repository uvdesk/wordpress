<?php
/**
 * WK_UVDESK_Api_Handler Token file handler
 *
 * @package UVdesk Free Helpdesk
 */

namespace WK_UVDESK\Helper;

defined( 'ABSPATH' ) || exit(); // Exit if accessed directly.

/** Check class exists or not */
if ( ! class_exists( 'WK_UVDESK_Api_Handler' ) ) {
	/**
	 * WK_UVDESK_Api_Handler class.
	 */
	class WK_UVDESK_Api_Handler extends WK_UVDESK_Protected {
		/**
		 ...
		 * @return mixed
		 */
		public static function wk_uvdesk_create_new_ticket_with_attachement( $post_attachment, $post_image = array() ) {
			$uv     = new WK_UVDESK_Protected();
		 ...
		 * @return mixed
		 */
		public static function wk_uvdesk_create_new_ticket( $post_array = array() ) {
			$uv     = new WK_UVDESK_Protected();
			$domain = $uv->get_company_domain();
			$url    = 'https://' . $domain . '.uvdesk.com/en/api/tickets.json';
